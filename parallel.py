...
def main(args):
    ...
    if not os.path.isfile(model_1st_path) and not os.path.isfile(model_2nd_path) or args.repeat == "True":
        ...
        args.experiment_name = 'parallel_1' + "_" + str(args.first_stage_data_name) + "_" + str(args.first_stage_noise_type)
        ...
        args.experiment_name = 'parallel_2' + "_" + str(args.first_stage_data_name) + "_" + str(args.first_stage_noise_type)
        ...
        args.experiment_name = 'parallel_1_cross' + "_" + str(args.first_stage_data_name) + "_" + str(args.first_stage_noise_type)
        ...
        args.experiment_name = 'parallel_2_cross' + "_" + str(args.first_stage_data_name) + "_" + str(args.first_stage_noise_type)
